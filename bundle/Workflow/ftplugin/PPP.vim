...
" a:date is a hash like the ones generated by Workflow#GetDateAsDictionary.
...
function! GetLogEntriesFrom( days_ago )
        ...
        return ReadLogEntriesFromFile( ReportFileNameForDate( Workflow#GetDateAsDictionary( a:days_ago ) ) )
endfunction

" GetToDoEntriesFrom( days_ago )
function! GetToDoEntriesFrom( days_ago )
        return ReadToDoEntriesFromFile( ReportFileNameForDate( Workflow#GetDateAsDictionary( a:days_ago ? a:days_ago : 0 ) ) ) 
endfunction
